...
public class ModPotions {
	public static final DeferredRegister<Potion> POTIONS = DeferredRegister.create(ForgeRegistries.POTIONS, Ichthyology.ID);
	...
	public static void brewingRecipes() {
		PotionBrewing.addMix(Potions.AWKWARD, ModItems.BLIND_CAVE_TETRA, BLINDNESS.get());
