...
public class PeacockBassModel extends EntityModel<PeacockBass> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 9.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.0F, 0.0F));

		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(0, 23).addBox(-1.5F, -2.0F, -1.0F, 3.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, 12.0F));
		...
		PartDefinition Head = Body.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(22, 0).addBox(-2.5F, 0.0F, -4.0F, 5.0F, 8.0F, 4.0F, new CubeDeformation(0.001F)), PartPose.offset(0.0F, 0.0F, -1.0F));
		...
		PartDefinition Dorsal_f_body = Body.addOrReplaceChild("Dorsal_f_body", CubeListBuilder.create().texOffs(37, 3).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 1.0F));

		PartDefinition Pelvic_f_l = Body.addOrReplaceChild("Pelvic_f_l", CubeListBuilder.create().texOffs(47, 20).addBox(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 8.0F, -1.0F));

		PartDefinition Pelvic_f_r = Body.addOrReplaceChild("Pelvic_f_r", CubeListBuilder.create().texOffs(54, 20).addBox(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 8.0F, -1.0F));

		PartDefinition Pectoral_f_l = Body.addOrReplaceChild("Pectoral_f_l", CubeListBuilder.create().texOffs(47, 32).addBox(-6.0F, -1.0F, 0.0F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 5.0F, -1.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition Pectoral_f_r = Body.addOrReplaceChild("Pectoral_f_r", CubeListBuilder.create().texOffs(47, 28).addBox(0.0F, -1.0F, 0.0F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 4.0F, -1.0F, 0.0F, -1.0472F, 0.0F));
	...
	public void setupAnim(PeacockBass entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.Tail_tip.yRot = 0.3F * Mth.sin(0.2F * ageInTicks);
		this.Tail_f.yRot = 0.325F * Mth.sin(0.2F * ageInTicks);
		this.Jaw.xRot = (0.1F * Mth.sin(0.1F * ageInTicks)) + (attackProgress * (float)Math.toRadians(50)) + 0.2346F;
		this.Anal_f.zRot = -0.2F * Mth.sin(0.2F * ageInTicks);
		this.Dorsal_f_tail.zRot = 0.2F * Mth.sin(0.2F * ageInTicks);
		this.Pelvic_f_l.zRot = 0.05F * Mth.sin(0.15F * ageInTicks);
		this.Pelvic_f_r.zRot = 0.05F * Mth.sin(0.15F * ageInTicks);
		this.Pelvic_f_l.xRot = -0.1F * Mth.sin(0.15F * ageInTicks) + 0.1F;
		this.Pelvic_f_r.xRot = -0.1F * Mth.sin(0.15F * ageInTicks) + 0.1F;
	}
